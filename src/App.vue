        ...
        >
          <div class="header-content">
            ...
            <div class="header-titles">
              <h2>Kai Jie Lie</h2>
              <h4>Blockchain Full Stack Developer</h4>
            </div>
          </div>
          ...
          <div class="social-links">
            <ul>
              ...
              <li>
                <a
                  href="https://web.facebook.com/NSL.DevMaster"
                  target="_blank"
                >
                  <font-awesome-icon
                    :icon="['fab', 'facebook']"
              ...
              <li>
                <a
                  href="https://www.instagram.com/devmaster2050/"
                  target="_blank"
                  ><font-awesome-icon
                    :icon="['fab', 'instagram']"
                    class="menu-icon"
          ...
          <div class="theme-circle-color">
            <div class="themes-buttons" ref="themes-buttons">
              <button
                ...
                :key="index"
                :class="
                  `${index} ${index == currentStoreTheme.theme ? 'active' : ''}`
                "
          ...
          <div class="header-buttons">
            <a
              href="/Kai-Jie-Lee-Resume-En.pdf"
              target="_blank"
          ...
          <a
            href="https://lmpixels.com/demo/breezycv/dark/1/"
            target="_blank"
            class="copyrights"
            >© INSPIRED BY breezycv.</a
          >
        </header>
